...
This directory contains a standalone CUDA harness for `DALI batched image flip`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/geometric/flip.cu
