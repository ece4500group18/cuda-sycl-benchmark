...
This directory contains a standalone CUDA harness for `DALI normalize and HWC-to-CHW permute`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/fused/normalize_permute.cu
