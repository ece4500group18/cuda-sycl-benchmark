...
This directory contains a standalone CUDA harness for `DALI bounding box horizontal flip`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/geometric/bb_flip.cu
