...
- Category: ai
- Operation: MMCV ROIAlign
- Source project: open-mmlab/mmcv
- Source URL: https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/roi_align_cuda.cu
- License: Apache-2.0
- CUDA features: ROI feature sampling, bilinear interpolation, pooled output
