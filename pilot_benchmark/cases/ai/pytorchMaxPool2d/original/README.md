...
This directory contains a standalone CUDA harness for `PyTorch MaxPool2d CUDA`.
...
Upstream source: pytorch/pytorch, https://github.com/pytorch/pytorch/blob/main/aten/src/ATen/native/cuda/MaxPool2d.cu
