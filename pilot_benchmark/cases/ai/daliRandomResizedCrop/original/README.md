...
This directory contains a standalone CUDA harness for `DALI random resized crop`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/resize/random_resized_crop.cu
