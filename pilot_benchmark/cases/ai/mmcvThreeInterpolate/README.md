...
- Category: ai
- Operation: MMCV three-point interpolation
- Source project: open-mmlab/mmcv
- Source URL: https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/three_interpolate_cuda.cu
- License: Apache-2.0
- CUDA features: point interpolation, weighted gather
- Input shape/sizes: [3, 12, 8]
