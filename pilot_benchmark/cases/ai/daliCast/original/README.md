...
This directory contains a standalone CUDA harness for `DALI cast with clamp and round`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/util/cast.cu
