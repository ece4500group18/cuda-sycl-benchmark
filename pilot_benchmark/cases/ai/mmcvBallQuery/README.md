...
- Category: ai
- Operation: MMCV ball query
- Source project: open-mmlab/mmcv
- Source URL: https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/ball_query_cuda.cu
- License: Apache-2.0
- CUDA features: point cloud query, radius search
- Input shape/sizes: [10, 12, 4]
- Output values: 40 floating-point lines
