...
This directory contains a standalone CUDA harness for `MMCV group points`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/group_points_cuda.cu
