...
This directory contains a standalone CUDA harness for `DALI fused resize crop mirror`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/fused/resize_crop_mirror.cu
