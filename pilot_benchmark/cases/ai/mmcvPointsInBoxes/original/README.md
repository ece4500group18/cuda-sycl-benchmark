...
This directory contains a standalone CUDA harness for `MMCV points in boxes`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/points_in_boxes_cuda.cu
