...
This directory contains a standalone CUDA harness for `MMCV ROIPool`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/roi_pool_cuda.cu
