# Case: reduceMax (medium)

| field | value |
| --- | --- |
| category | medium |
| operation | Parallel max reduction |
| correctness | cpu_reference / max_abs_error (tol 0.0) |
| CUDA features | __shared__, __syncthreads, reduction |
| libraries | - |

Notes: Max is order-independent; exact match expected.
