...
This directory contains a standalone CUDA harness for `MMCV furthest point sampling`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/furthest_point_sample_cuda.cu
