...
This directory contains a standalone CUDA harness for `MMCV non-maximum suppression`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/nms_cuda.cu
