...
This directory contains a standalone CUDA harness for `DALI paste/composite`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/paste/paste.cu
