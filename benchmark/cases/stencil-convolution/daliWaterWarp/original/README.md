...
This directory contains a standalone CUDA harness for `DALI nonlinear water warp`.
...
Upstream source: NVIDIA/DALI, https://github.com/NVIDIA/DALI/blob/main/dali/operators/displacement/water.cu
