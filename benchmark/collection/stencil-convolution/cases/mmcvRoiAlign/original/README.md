...
This directory contains a standalone CUDA harness for `MMCV ROIAlign`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/roi_align_cuda.cu
