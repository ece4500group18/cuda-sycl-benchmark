...
This directory contains a standalone CUDA harness for `MMCV ball query`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/ball_query_cuda.cu
