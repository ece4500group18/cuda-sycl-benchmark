...
This directory contains a standalone CUDA harness for `MMCV three-point interpolation`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/three_interpolate_cuda.cu
