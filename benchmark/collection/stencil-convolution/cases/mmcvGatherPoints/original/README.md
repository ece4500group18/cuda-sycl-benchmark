...
This directory contains a standalone CUDA harness for `MMCV gather points`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/gather_points_cuda.cu
