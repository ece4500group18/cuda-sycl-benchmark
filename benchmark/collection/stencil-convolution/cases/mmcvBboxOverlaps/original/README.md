...
This directory contains a standalone CUDA harness for `MMCV bounding-box overlaps`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/bbox_overlaps_cuda.cu
