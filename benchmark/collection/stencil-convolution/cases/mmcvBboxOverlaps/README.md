...
- Category: ai
- Operation: MMCV bounding-box overlaps
- Source project: open-mmlab/mmcv
- Source URL: https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/bbox_overlaps_cuda.cu
- License: Apache-2.0
- CUDA features: bbox geometry, IoU, nested loops
- Input shape/sizes: [12, 10]
- Output values: 120 floating-point lines
