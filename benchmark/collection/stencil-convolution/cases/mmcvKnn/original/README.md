...
This directory contains a standalone CUDA harness for `MMCV KNN`.
...
Upstream source: open-mmlab/mmcv, https://github.com/open-mmlab/mmcv/blob/main/mmcv/ops/csrc/pytorch/cuda/knn_cuda.cu
